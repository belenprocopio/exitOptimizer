...
class BESS_lab:
    ...
    def __init__(self, bat_ini = 0.5,num_bat = 1, debug=False):
        ...
        self.max_power_discharge = -7.5*self.num_bat # el que decarrega hora max kW
        self.max_power_charge = 7.5*self.num_bat # el que carrega hora max kW

        self.bat_max = 5.8*2*self.num_bat #11.6 #Maxim en KW, 5.8 kW por modulo (BMS_BatteryCapacity: 0x0026)
    ...
    def control(self, method = 'discharge', load = 3, production = 2):
        if method == 'charge':
