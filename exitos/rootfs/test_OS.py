...
for i in range(0,24):
    ...
    post_state.post_state("input_number.prediccion_potencia_bateria_master",wh[i]/2)
    print("Potencia Bateria 1 Valor ",i," Publicada: ", wh[i]/2)
    post_state.post_state("input_number.prediccion_potencia_bateria_slave",wh[i]/2)
    print("Potencia Bateria 2 Valor ",i," Publicada: ", wh[i]/2)
