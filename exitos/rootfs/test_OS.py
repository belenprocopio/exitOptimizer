...
post_state.post_state("input_number.potencia_bateria_slave",kWh_slave[25])
print("Potencia Slave Publicada: ", kWh_slave[25])
post_state.post_state("input_number.soc_bateria_master",SoC_slave[1])
print("SoC Master Publicado: ", SoC_slave[1])
post_state.post_state("input_number.soc_bateria_slave",SoC_slave[25])
print("SoC Slave Publicado: ", SoC_slave[25])
